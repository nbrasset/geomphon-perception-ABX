// Gaussian centred at 0.5 and truncated to be nonnegative for certain predictors
...
parameters {
  vector<lower=0>[N_cf_cns] beta_cns; // constrained betas
